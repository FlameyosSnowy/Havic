...
public abstract class ContextCommand<S extends Sender> implements CommandHandler<S> {
    ...
    private Map<String, CommandHandler<S>> container;
    ...
    private Map<String, CommandHandler<S>> getContainer() {
        return (container == null) ? (container = new HashMap<>(5)) : container;
    }
