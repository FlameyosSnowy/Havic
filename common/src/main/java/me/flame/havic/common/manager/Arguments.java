...
public final class Arguments {
    ...
    public String get(int index) {
        return (index < 0 || index >= length) ? null : args[index];
    }
    ...
    public String getQuoting(final int index) {
        ...
        return quoteStringWhilePossible(number, index, length, arg, args, builder);
    }
    ...
    private static String quoteStringWhilePossible(int execution, int index, int length, final CharSequence arg, final String[] args, final StringBuilder builder) {
